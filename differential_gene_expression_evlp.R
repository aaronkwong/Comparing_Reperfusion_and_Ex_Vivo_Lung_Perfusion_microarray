...
write.table(batch2_summ, file =paste0(root_directory,"/batch_2_improved_summ.tab"),row.names=TRUE,sep="\t",col.names=NA)
#hist(summ$fdr)
#need to find intersecting genes between batch_0 and batch_2 if you want this

#make rnk file for batch2
